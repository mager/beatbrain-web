    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 mt-5 flex-wrap justify-center md:justify-start">
          {!hideSaveButton && (
            <button
              className="inline-flex items-center gap-2 font-mono text-[11px] px-4 py-2 rounded-lg transition-all border border-white/25 text-white/80 hover:border-white/50 hover:text-white hover:bg-white/8"
          ...
          <ExternalLinks links={track.links} light />
        </div>
